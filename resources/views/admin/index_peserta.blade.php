...
<div class="flex flex-col space-y-8">
    ...
    {{-- Table Data --}}
    <div class="bg-white rounded-[3rem] border border-slate-50 overflow-hidden shadow-sm shadow-blue-900/5">
        <table class="w-full text-left">
            <thead class="bg-[#AEE2FF] text-slate-700 font-bold text-xs uppercase tracking-wider">
                <tr>
                    ...
                    <th class="px-8 py-5">No ID PKL</th>
                    <th class="px-8 py-5">Jurusan</th>
            ...
            <tbody class="divide-y divide-slate-50 text-sm text-slate-600">
                ...
                @empty
                <tr><td colspan="7" class="px-8 py-20 text-center text-slate-400 italic font-medium">Data tidak ditemukan.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
...
{{-- MODAL EDIT PESERTA --}}
<div id="modalEdit" class="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[150] hidden flex items-center justify-center p-4">
    <div class="bg-white rounded-[2.5rem] w-full max-w-2xl p-10 shadow-2xl transform transition-all duration-300">
        ...
        <form id="formEditPeserta" method="POST">
            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    <label class="text-[10px] font-bold text-slate-400 uppercase tracking-widest ml-1">ID Login</label>
